...
public class ActSorteioDuplaSena extends AppCompatActivity {

    // Constantes
    private final String LOTERIA = "dupla_sena";
    private String url;
    ...
    private TextView textNumero1,textNumero2, textNumero3, textNumero4, textNumero5, textNumero6, textNumero7, textNumero8, textNumero9,
            textNumero10, textNumero11, textNumero12;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_act_sorteio_dupla_sena);

        /* Toolbar */
        toolbarPrincipal = (Toolbar) findViewById(R.id.toolbarPrincipal);
        toolbarPrincipal.setTitle(getResources().getString(R.string.menu_duplasena));
    ...
    public void gravaCache(String concurso, String data, String dezenas[]){
        SharedPreferences prefs = getSharedPreferences("dezenas_duplasena", 0);
    ...
    public class Loterias extends AsyncTask<Void, Void, String> {
        ...
        // Construtor
        public Loterias(String url, ActSorteioDuplaSena activity) {
            this.url = url;
        ...
        protected void onPostExecute(String s) {
            if (s.equalsIgnoreCase("") || s.contains("expirado")) {
                ...
                Toast.makeText(ActSorteioDuplaSena.this, getResources().getString(R.string.texto_semconexao), Toast.LENGTH_SHORT).show();
        ...
        public void parseJson(String json){
            try {
                ...
                String dezenas = dezenasSorteadas.getString("first_draw") + "," + dezenasSorteadas.getString("second_draw");

                Log.d("DEZENAS", dezenas);
        ...
        public void preencheResultado(String concurso, String data, String dezenas){
            ...
            textCabecalho.setText(getResources().getString(R.string.texto_cabecalho_duplasena) + " " + concurso + " (" + data + ")");
