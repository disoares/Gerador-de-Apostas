...
public class ActSorteioMegaSena extends AppCompatActivity {

    // Constantes
    private final String LOTERIA = "mega-sena";
    ...
    private TextView textNumero1,textNumero2, textNumero3, textNumero4, textNumero5, textNumero6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_act_sorteio_mega_sena);

        /* Toolbar */
        toolbarPrincipal = findViewById(R.id.toolbarPrincipal);
        toolbarPrincipal.setTitle(getResources().getString(R.string.menu_megasena));
    ...
    public void gravaCache(String concurso, String data, String dezenas[]){
        SharedPreferences prefs = getSharedPreferences("dezenas_megasena", 0);
    ...
    public class Loterias extends AsyncTask<Void, Void, String> {
        ...
        // Construtor
        public Loterias(String url, ActSorteioMegaSena activity) {
            this.url = url;
        ...
        protected void onPostExecute(String s) {
            if (s.equalsIgnoreCase("") || s.contains("expirado")) {
                ...
                Toast.makeText(ActSorteioMegaSena.this, getResources().getString(R.string.texto_semconexao), Toast.LENGTH_SHORT).show();
        ...
        public void preencheResultado(String concurso, String data, String dezenas){
            ...
            textCabecalho.setText(getResources().getString(R.string.texto_cabecalho_megasena) + " " + concurso + " (" + data + ")");
